...
begin
    ...
    with LblGCM do begin
        Parent:=ExtraOptionsPage.Surface;
        Caption:=
            'The Git Credential Manager for Windows provides secure Git credential storage'+#13+'for Windows, most notably multi-factor authentication support for Visual Studio'+#13+'Team Services and GitHub.';
        Left:=ScaleX(28);
        Top:=ScaleY(104);
        Width:=ScaleX(405);
        Height:=ScaleY(39);
